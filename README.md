...
After these steps a file **joyit_nodemcu_esp32_ex.yaml** has been created in the /config folder. You can view it's contents here. [here](https://github.com/goofy2k/ESPhome_codes/blob/main/media/joyit_nodemcu_esp32_ex.yaml)
...
It makes no sense to use the Upload or Logs buttons now as the board does not have OTA Upload capabilities and is not yet connected with the ESPHome API server. You can try Logs and see the messages....
